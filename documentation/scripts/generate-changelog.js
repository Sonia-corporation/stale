...
async function initialize() {
  ...
  execSync(`npm run lint:other:this -- documentation/docs/13-changelog.md`, {
    stdio: `inherit`,
  });
...
async function loadDocumentationChangelog() {
  ...
  const changelog = await FS.readFile(`documentation/docs/13-changelog.md`, `utf-8`);
...
async function updateDocumentationChangelog(content) {
  ...
  await FS.writeFile(`documentation/docs/13-changelog.md`, content);
