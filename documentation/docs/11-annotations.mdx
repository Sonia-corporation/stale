...
## Notices :information_source: {#notices}
...
If you came across one of them, simply open a new ticket (see the [help](./need-help) to know how) so that we can change our priorities.
...
Anyhow, if you came across one of those, you can open a new bug ticket (see the [help](./need-help) to know how) so that we can fix it as soon as possible.
