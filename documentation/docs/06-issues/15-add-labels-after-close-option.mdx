---
id: issue-add-labels-after-close-option
title: Add issue labels after close option
tags:
  - Issues
  - Options
---
...
This option will let you add extra labels when the processing close the issues.  
