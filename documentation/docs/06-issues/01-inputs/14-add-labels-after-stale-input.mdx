---
id: issue-add-labels-after-stale-input
title: Add issue labels after stale input
description: |
  All the information you need to know about the add issue labels after stale input.
