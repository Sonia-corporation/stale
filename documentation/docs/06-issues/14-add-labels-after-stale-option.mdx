---
id: issue-add-labels-after-stale-option
title: Add issue labels after stale option
tags:
  - Issues
  - Options
---
...
This option will let you add extra labels when the processing stale the issues.  
