...
| [issues-labels-count](issues/outputs/issues-labels-count-output)                                                  | The number of mutated issues labels (added or removed).                            | `number` |
| [added-issues-labels-count](issues/outputs/added-issues-labels-count-output)                                      | The number of added issues labels.                                                 | `number` |
| [removed-issues-labels-count](issues/outputs/removed-issues-labels-count-output)                                  | The number of removed issues labels.                                               | `number` |
