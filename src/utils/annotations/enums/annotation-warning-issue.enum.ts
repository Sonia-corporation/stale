export enum EAnnotationWarningIssue {
  ...
  TOO_MANY_PROJECT_CARDS_PAGINATION_NOT_IMPLEMENTED = `Found too many project cards attached on this issue. The pagination support is not yet implemented and may cause a mismatch!`,
}
