export enum EInputs {
  ...
  ISSUE_IGNORE_ALL_PROJECTS = `issue-ignore-all-projects`,
  ...
  ISSUE_IGNORE_ANY_PROJECTS = `issue-ignore-any-projects`,
  ...
  ISSUE_ONLY_WITH_PROJECTS = `issue-only-with-projects`,
  ISSUE_ONLY_ANY_MILESTONES = `issue-only-any-milestones`,
  ISSUE_ONLY_ANY_PROJECTS = `issue-only-any-projects`,
  ...
  PULL_REQUEST_IGNORE_ALL_PROJECTS = `pull-request-ignore-all-projects`,
  ...
  PULL_REQUEST_IGNORE_ANY_PROJECTS = `pull-request-ignore-any-projects`,
  ...
  PULL_REQUEST_ONLY_WITH_PROJECTS = `pull-request-only-with-projects`,
  PULL_REQUEST_ONLY_ANY_ASSIGNEES = `pull-request-only-any-assignees`,
  PULL_REQUEST_ONLY_ANY_PROJECTS = `pull-request-only-any-projects`,
