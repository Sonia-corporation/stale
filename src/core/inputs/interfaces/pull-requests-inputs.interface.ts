...
export interface IPullRequestsInputs extends IInputs {
  ...
  readonly pullRequestIgnoreAllProjects: boolean;
  ...
  readonly pullRequestIgnoreAnyProjects: string[];
