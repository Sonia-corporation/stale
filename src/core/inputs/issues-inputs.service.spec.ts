...
describe(`IssuesInputsService`, (): void => {
  ...
  describe(`setInputs()`, (): void => {
    ...
    it(`should get the issue-add-labels-after-close input, parse it and set it`, (): void => {
      ...
      expect(coreGetMultilineInputSpy).toHaveBeenCalledTimes(6);
    ...
    it(`should get the issue-only-any-milestones input, parse it and set it`, (): void => {
      ...
      expect(coreGetMultilineInputSpy).toHaveBeenCalledTimes(6);
      expect(coreGetMultilineInputSpy).toHaveBeenNthCalledWith(5, `issue-only-any-milestones`, { required: false });
    ...
    it(`should get the issue-only-any-project-cards input, parse it and set it`, (): void => {
      ...
      expect(coreGetMultilineInputSpy).toHaveBeenCalledTimes(6);
      expect(coreGetMultilineInputSpy).toHaveBeenNthCalledWith(6, `issue-only-any-project-cards`, { required: false });
  ...
  describe(`logInputs()`, (): void => {
    ...
    describe(`when the inputs are set`, (): void => {
      ...
      it(`should log the issue add labels after close input`, (): void => {
        ...
        expect(loggerServiceInfoSpy).toHaveBeenCalledTimes(18);
        ...
        expect(loggerServiceInputSpy).toHaveBeenCalledTimes(18);
      ...
      it(`should log the issue limit api mutations count input`, (): void => {
        ...
        expect(loggerServiceInputSpy).toHaveBeenCalledTimes(18);
        expect(loggerServiceInputSpy).toHaveBeenNthCalledWith(12, `issue-limit-api-mutations-count`);
      });
      ...
      it(`should log the issue limit api queries count input`, (): void => {
        ...
        expect(loggerServiceInputSpy).toHaveBeenCalledTimes(18);
        expect(loggerServiceInputSpy).toHaveBeenNthCalledWith(13, `issue-limit-api-queries-count`);
      });
      ...
      it(`should log the issue only any milestones input`, (): void => {
        ...
        expect(loggerServiceInputSpy).toHaveBeenCalledTimes(18);
        expect(loggerServiceInputSpy).toHaveBeenNthCalledWith(14, `issue-only-any-milestones`);
      });
      ...
      it(`should log the issue only any project cards input`, (): void => {
        ...
        expect(loggerServiceInputSpy).toHaveBeenCalledTimes(18);
        expect(loggerServiceInputSpy).toHaveBeenNthCalledWith(15, `issue-only-any-project-cards`);
      });
      ...
      it(`should log the issue processing input`, (): void => {
        ...
        expect(loggerServiceInfoSpy).toHaveBeenCalledTimes(18);
        expect(loggerServiceInfoSpy).toHaveBeenNthCalledWith(16, `white-├──`, `input-issue-processing`, `value-false`);
        expect(loggerServiceInputSpy).toHaveBeenCalledTimes(18);
        expect(loggerServiceInputSpy).toHaveBeenNthCalledWith(16, `issue-processing`);
      });
      ...
      it(`should log the issue stale comment input`, (): void => {
        ...
        expect(loggerServiceInputSpy).toHaveBeenCalledTimes(18);
        expect(loggerServiceInputSpy).toHaveBeenNthCalledWith(17, `issue-stale-comment`);
      });
      ...
      it(`should log the issue stale label input`, (): void => {
        ...
        expect(loggerServiceInputSpy).toHaveBeenCalledTimes(18);
        expect(loggerServiceInputSpy).toHaveBeenNthCalledWith(18, `issue-stale-label`);
      });
    });
