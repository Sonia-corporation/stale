...
describe(`PullRequestsInputsService`, (): void => {
  ...
  describe(`setInputs()`, (): void => {
    ...
    it(`should get the pull-request-ignore-draft input, parse it and set it`, (): void => {
      ...
      expect(coreGetBooleanInputSpy).toHaveBeenCalledTimes(4);
      expect(coreGetBooleanInputSpy).toHaveBeenNthCalledWith(4, `pull-request-ignore-draft`, {
        required: false,
      });
  ...
  describe(`logInputs()`, (): void => {
    ...
    describe(`when the inputs are set`, (): void => {
      ...
      it(`should log the pull request ignore draft input`, (): void => {
        ...
        expect(loggerServiceInputSpy).toHaveBeenCalledTimes(12);
        expect(loggerServiceInputSpy).toHaveBeenNthCalledWith(10, `pull-request-ignore-draft`);
      });
      ...
      it(`should log the pull request stale comment input`, (): void => {
        ...
        expect(loggerServiceInputSpy).toHaveBeenCalledTimes(12);
        expect(loggerServiceInputSpy).toHaveBeenNthCalledWith(11, `pull-request-stale-comment`);
      });
      ...
      it(`should log the pull request stale label input`, (): void => {
        ...
        expect(loggerServiceInputSpy).toHaveBeenCalledTimes(12);
        expect(loggerServiceInputSpy).toHaveBeenNthCalledWith(12, `pull-request-stale-label`);
      });
    });
