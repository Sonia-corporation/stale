...
describe(`PullRequestsInputsService`, (): void => {
  ...
  describe(`setInputs()`, (): void => {
    ...
    it(`should get the pull-request-only-any-milestones input, parse it and set it`, (): void => {
      ...
      expect(coreGetMultilineInputSpy).toHaveBeenCalledTimes(6);
      expect(coreGetMultilineInputSpy).toHaveBeenNthCalledWith(5, `pull-request-only-any-milestones`, {
        required: false,
      });
    ...
    it(`should get the pull-request-only-any-project-cards input, parse it and set it`, (): void => {
      ...
      expect(coreGetMultilineInputSpy).toHaveBeenCalledTimes(6);
      expect(coreGetMultilineInputSpy).toHaveBeenNthCalledWith(6, `pull-request-only-any-project-cards`, {
        required: false,
      });
  ...
  describe(`logInputs()`, (): void => {
    ...
    describe(`when the inputs are set`, (): void => {
      ...
      it(`should log the pull request only any milestones input`, (): void => {
        ...
        expect(loggerServiceInputSpy).toHaveBeenCalledTimes(21);
        expect(loggerServiceInputSpy).toHaveBeenNthCalledWith(16, `pull-request-only-any-milestones`);
      });
      ...
      it(`should log the pull request only any project cards input`, (): void => {
        ...
        expect(loggerServiceInputSpy).toHaveBeenCalledTimes(21);
        expect(loggerServiceInputSpy).toHaveBeenNthCalledWith(17, `pull-request-only-any-project-cards`);
      });
      ...
      it(`should log the pull request processing input`, (): void => {
        ...
        expect(loggerServiceInputSpy).toHaveBeenCalledTimes(21);
        expect(loggerServiceInputSpy).toHaveBeenNthCalledWith(18, `pull-request-processing`);
      });
      ...
      it(`should log the pull request stale comment input`, (): void => {
        ...
        expect(loggerServiceInputSpy).toHaveBeenCalledTimes(21);
        expect(loggerServiceInputSpy).toHaveBeenNthCalledWith(19, `pull-request-stale-comment`);
      });
      ...
      it(`should log the pull request stale label input`, (): void => {
        ...
        expect(loggerServiceInputSpy).toHaveBeenCalledTimes(21);
        expect(loggerServiceInputSpy).toHaveBeenNthCalledWith(20, `pull-request-stale-label`);
      });
      ...
      it(`should log the pull request to draft instead of stale input`, (): void => {
        ...
        expect(loggerServiceInputSpy).toHaveBeenCalledTimes(21);
        expect(loggerServiceInputSpy).toHaveBeenNthCalledWith(21, `pull-request-to-draft-instead-of-stale`);
      });
    });
