  ...
  describe(`logInputs()`, (): void => {
    ...
    describe(`when the inputs are set`, (): void => {
      ...
      it(`should log the pull request delete branch after close input`, (): void => {
        ...
        expect(loggerServiceInputSpy).toHaveBeenCalledTimes(13);
        expect(loggerServiceInputSpy).toHaveBeenNthCalledWith(4, `pull-request-delete-branch-after-close`);
      });
      ...
      it(`should log the pull request ignore all assignees input`, (): void => {
        ...
        expect(loggerServiceInputSpy).toHaveBeenCalledTimes(13);
        expect(loggerServiceInputSpy).toHaveBeenNthCalledWith(5, `pull-request-ignore-all-assignees`);
      });
      ...
      it(`should log the pull request ignore all labels input`, (): void => {
        ...
        expect(loggerServiceInputSpy).toHaveBeenCalledTimes(13);
        expect(loggerServiceInputSpy).toHaveBeenNthCalledWith(6, `pull-request-ignore-all-labels`);
      });
      ...
      it(`should log the pull request ignore all project cards input`, (): void => {
        ...
        expect(loggerServiceInputSpy).toHaveBeenCalledTimes(13);
        expect(loggerServiceInputSpy).toHaveBeenNthCalledWith(7, `pull-request-ignore-all-project-cards`);
      });
      ...
      it(`should log the pull request ignore any assignees input`, (): void => {
        ...
        expect(loggerServiceInputSpy).toHaveBeenCalledTimes(13);
        expect(loggerServiceInputSpy).toHaveBeenNthCalledWith(8, `pull-request-ignore-any-assignees`);
      });
      ...
      it(`should log the pull request ignore any labels input`, (): void => {
        ...
        expect(loggerServiceInputSpy).toHaveBeenCalledTimes(13);
        expect(loggerServiceInputSpy).toHaveBeenNthCalledWith(9, `pull-request-ignore-any-labels`);
      });
      ...
      it(`should log the pull request ignore before creation date input`, (): void => {
        ...
        expect(loggerServiceInputSpy).toHaveBeenCalledTimes(13);
        expect(loggerServiceInputSpy).toHaveBeenNthCalledWith(10, `pull-request-ignore-before-creation-date`);
      });
      ...
      it(`should log the pull request ignore draft input`, (): void => {
        ...
        expect(loggerServiceInputSpy).toHaveBeenCalledTimes(13);
        expect(loggerServiceInputSpy).toHaveBeenNthCalledWith(11, `pull-request-ignore-draft`);
      });
      ...
      it(`should log the pull request stale comment input`, (): void => {
        ...
        expect(loggerServiceInputSpy).toHaveBeenCalledTimes(13);
        expect(loggerServiceInputSpy).toHaveBeenNthCalledWith(12, `pull-request-stale-comment`);
      });
      ...
      it(`should log the pull request stale label input`, (): void => {
        ...
        expect(loggerServiceInputSpy).toHaveBeenCalledTimes(13);
        expect(loggerServiceInputSpy).toHaveBeenNthCalledWith(13, `pull-request-stale-label`);
      });
    });
