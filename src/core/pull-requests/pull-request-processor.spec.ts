import { PullRequestCloseStaleProcessor } from '@core/pull-requests/pull-request-close-stale-processor';
...
import { PullRequestRemoveStaleProcessor } from '@core/pull-requests/pull-request-remove-stale-processor';
import { PullRequestShouldCloseStaleProcessor } from '@core/pull-requests/pull-request-should-close-stale-processor';
...
jest.mock(`@core/pull-requests/pull-request-logger`);
jest.mock(`@core/pull-requests/pull-request-ignore-processor`);
jest.mock(`@core/pull-requests/pull-request-stale-processor`);
jest.mock(`@core/pull-requests/pull-request-is-stale-processor`);
jest.mock(`@core/pull-requests/pull-request-remove-stale-processor`);
jest.mock(`@core/pull-requests/pull-request-should-close-stale-processor`);
jest.mock(`@core/pull-requests/pull-request-close-stale-processor`);
