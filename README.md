...
| **Projects**                                                                                                                          |                                                                                                                                                 |               |
| [issue-ignore-all-projects](https://sonia-stale-action.vercel.app/docs/issues/inputs/issue-ignore-all-projects-input)                 | Allow to ignore the processing of issues that contains any projects.                                                                            | `false`       |
| [issue-ignore-any-projects](https://sonia-stale-action.vercel.app/docs/issues/inputs/issue-ignore-any-projects-input)                 | Allow to ignore the processing of issues that contains one of those projects (multiline).                                                       |               |
| [issue-only-with-projects](https://sonia-stale-action.vercel.app/docs/issues/inputs/issue-only-wih-projects-input)                    | Only allow the processing of issues that contains at least one project.                                                                         | `false`       |
| [issue-only-any-projects](https://sonia-stale-action.vercel.app/docs/issues/inputs/issue-only-any-projects-input)                     | Only allow the processing of issues that contains one of those projects (multiline).                                                            |               |
| **Milestones**                                                                                                                        |                                                                                                                                                 |               |
...
| **Projects**                                                                                                                                               |                                                                                                                                                        |         |
| [pull-request-ignore-all-projects](https://sonia-stale-action.vercel.app/docs/pull-requests/inputs/pull-request-ignore-all-projects-input)                 | Allow to ignore the processing of pull requests that contains any projects.                                                                            | `false` |
| [pull-request-ignore-any-projects](https://sonia-stale-action.vercel.app/docs/pull-requests/inputs/pull-request-ignore-any-projects-input)                 | Allow to ignore the processing of pull requests that contains one of those projects (multiline).                                                       |         |
| [pull-request-only-with-projects](https://sonia-stale-action.vercel.app/docs/pull-requests/inputs/pull-request-only-with-projects-input)                   | Only allow the processing of pull requests that contains at least one project.                                                                         | `false` |
| [pull-request-only-any-projects](https://sonia-stale-action.vercel.app/docs/pull-requests/inputs/pull-request-only-any-projects-input)                     | Only allow the processing of pull requests that contains one of those projects (multiline).                                                            |         |
| **Milestones**                                                                                                                                             |                                                                                                                                                        |         |
